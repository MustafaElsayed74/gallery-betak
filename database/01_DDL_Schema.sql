-- =====================================================================
-- ElMasria E-Commerce Platform — Complete DDL Schema
...
(
    ...
    CONSTRAINT [CK_Products_OriginalPrice] CHECK ([OriginalPrice] IS NULL OR [OriginalPrice] > [Price]),
...
(
    ...
    [Label]           NVARCHAR(100)   NOT NULL,       -- e.g. "المنزل", "العمل"
    [RecipientName]   NVARCHAR(200)   NOT NULL,
    [Phone]           NVARCHAR(20)    NOT NULL,
    [Governorate]     NVARCHAR(100)   NOT NULL,       -- محافظة
    [City]            NVARCHAR(100)   NOT NULL,
    [District]        NVARCHAR(100)   NULL,            -- الحي
...
(
    ...
    [MaxDiscountAmount] DECIMAL(18,2)   NULL,            -- cap for percentage discounts
...
(
    ...
    CONSTRAINT [FK_CouponUsages_User] FOREIGN KEY ([UserId])
        REFERENCES [dbo].[AspNetUsers]([Id]) ON DELETE RESTRICT
...
(
    [Id]            INT             IDENTITY(1,1) NOT NULL,
    [UserId]        NVARCHAR(450)   NULL,               -- NULL for guest carts
    [SessionId]     NVARCHAR(100)   NULL,               -- for guest identification
    [CouponId]      INT             NULL,
    [ExpiresAt]     DATETIME2(7)    NOT NULL,
    [CreatedAt]     DATETIME2(7)    NOT NULL DEFAULT SYSUTCDATETIME(),
    [UpdatedAt]     DATETIME2(7)    NULL,
...
(
    ...
    CONSTRAINT [CK_CartItems_Quantity] CHECK ([Quantity] > 0 AND [Quantity] <= 99),
...
(
    ...
    CONSTRAINT [FK_WishlistItems_Product] FOREIGN KEY ([ProductId])
        REFERENCES [dbo].[Products]([Id]) ON DELETE RESTRICT,
    CONSTRAINT [UQ_WishlistItems_WishlistProduct] UNIQUE ([WishlistId], [ProductId])
);
...
(
    [Id]              INT             IDENTITY(1,1) NOT NULL,
    [OrderNumber]     NVARCHAR(20)    NOT NULL,           -- Format: ORD-YYYYMM-NNNNN
    [UserId]          NVARCHAR(450)   NULL,               -- SET NULL on user delete
    ...
    [CouponId]        INT             NULL,
    [CouponCode]      NVARCHAR(50)    NULL,               -- snapshot
...
(
    [Id]              INT             IDENTITY(1,1) NOT NULL,
    [OrderId]         INT             NOT NULL,
    [ProductId]       INT             NULL,               -- keep reference but don't depend on it
    [ProductNameAr]   NVARCHAR(300)   NOT NULL,           -- snapshot
    [ProductNameEn]   NVARCHAR(300)   NOT NULL,           -- snapshot
    [ProductSKU]      NVARCHAR(50)    NOT NULL,           -- snapshot
    [ProductImageUrl] NVARCHAR(500)   NULL,               -- snapshot
    [UnitPrice]       DECIMAL(18,2)   NOT NULL,           -- frozen at order time
...
(
    ...
    [Type]          NVARCHAR(50)    NOT NULL,             -- OrderUpdate, Payment, Promotion, System
    [ReferenceId]   INT             NULL,                 -- e.g. OrderId
    [ReferenceType] NVARCHAR(50)    NULL,                 -- e.g. "Order", "Product"
...
(
    ...
    [Action]        NVARCHAR(100)   NOT NULL,             -- e.g. "CreateProduct", "UpdateOrder"
    [EntityType]    NVARCHAR(100)   NOT NULL,             -- e.g. "Product", "Order"
