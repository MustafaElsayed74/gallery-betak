...
public interface IEmailService
{
    ...
    Task SendOrderTrackingEmailAsync(string toEmail, int orderId, string orderNumber, string status, string? trackingNumber, CancellationToken cancellationToken = default);
