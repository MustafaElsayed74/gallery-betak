...
public sealed class UnitOfWork : IUnitOfWork
{
    ...
    private IGenericRepository<CustomerServiceMessage>? _customerServiceMessages;
    ...
    /// <inheritdoc/>
    public IGenericRepository<CustomerServiceMessage> CustomerServiceMessages =>
        _customerServiceMessages ??= new GenericRepository<CustomerServiceMessage>(_context);
