    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerServiceMessages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageEn = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingRecipientName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    ShippingStreetAddress = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    ShippingBuildingNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ShippingApartmentNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerServiceMessages_CreatedAt",
                table: "CustomerServiceMessages",
                column: "CreatedAt",
                descending: new bool[0]);

            migrationBuilder.CreateIndex(
                name: "IX_CustomerServiceMessages_Status",
                table: "CustomerServiceMessages",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerServiceMessages_Status_CreatedAt",
                table: "CustomerServiceMessages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ImportedAt",
                table: "Products",
                column: "ImportedAt",
                filter: "[IsDeleted] = 0 AND [ImportedAt] IS NOT NULL");
