...
public sealed class JwtTokenService
{
    ...
    public (string Token, DateTime ExpiresAt) GenerateAccessToken(ApplicationUser user, IList<string> roles)
    {
        ...
        var issuer = jwtSettings["Issuer"] ?? "ElMasria.API";
        var audience = jwtSettings["Audience"] ?? "ElMasria.Client";
    ...
    public ClaimsPrincipal? GetPrincipalFromExpiredToken(string token)
    {
        ...
        var validationParameters = new TokenValidationParameters
        {
            ...
            ValidateIssuer = true,
            ValidIssuer = jwtSettings["Issuer"] ?? "ElMasria.API",
            ValidateAudience = true,
            ValidAudience = jwtSettings["Audience"] ?? "ElMasria.Client",
